...
<div class="col-md-2" style="margin-top: 4%;">
    <div style="margin-bottom: 10px;">
        <button type="button" class="btn btn-primary input-group"><a href="#" style="color: white">Điều kiện xét tuyển</a></button>
    </div>
    <div style="margin-bottom: 10px;">
        <button type="button" class="btn btn-info input-group"><a  href="#" style="color: white">Ngành xét tuyển</a></button>
    </div>
    <div style="margin-bottom: 10px;">
        <button type="button" class="btn btn-danger input-group"><a  href="#" style="color: white">Hồ sơ và cách đăng ký</a></button>
    </div>
    <div style="margin-bottom: 10px;">
...
<div class="col-md-8">
    <form method="post" name="form_xet_tuyen" >
        ...
        <div class="slect-hinh-thuc ">
            ...
            <div class="col-md-12">
                <div class="input-group-prepend">
                    <input type="checkbox" name="admission[]" value="1"> Tuyển bằng tổng điểm trung bình lớp 12 theo tổ hợp 3 môn
                </div>
            </div>
        </div>
            <div class="input-group-prepend" style="margin-bottom: 20px">
            <div class="col-md-12">
                <div class="input-group-prepend">
                    <input type="checkbox" name="admission[]" value="2"> Tuyển bằng tổng điểm trung bình 3 học kỳ(HK1,HK2 năm lớp 11 và HK1 năm lớp 12)
                </div>
            </div>
        </div>
            <div class="input-group-prepend" style="margin-bottom: 20px">
            <div class="col-md-12">
                <div class="input-group-prepend">
                    <b>Lưu ý</b>Thí sinh có thể chọn một trong hai hoặc chọn cả hai để tăng cơ hội trúng tuyển
                </div>
            </div>
        </div>
        </div>
